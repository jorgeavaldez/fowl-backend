defmodule Fowl.AccountsTest do
  use Fowl.DataCase
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      assert Argon2.verify_pass("some encrypted_password", user.encrypted_password)
    end
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert Argon2.verify_pass("some updated encrypted_password", user.encrypted_password)
    end
